...
func (g *Golaravel) RandomString(n int) string {
...
func (g *Golaravel) CreateDirIfNotExist(path string) error {
	const mode = 0755
...
func (g *Golaravel) CreateFileIfNotExist(path string) error {
